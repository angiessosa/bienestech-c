...
class Taller(Base):
    ...
    # Relación con UsuarioTaller
    usuario_taller = relationship("UsuarioTaller", back_populates="taller")
...
class UsuarioTaller(Base):
    ...
    # Relación con Taller
    taller = relationship("Taller", back_populates="usuarios_taller")

    # Relación con Usuario (asumiendo que tienes el modelo de usuario ya definido)
    usuario = relationship("Usuario", back_populates="usuario_taller")
